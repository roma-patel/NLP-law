...
if __name__=="__main__":
    ...
    wvec_paths = {'google': '/nlp/data/corpora/GoogleNews-vectors-negative300.bin', 'random': '/nlp/data/romap/ambig/w2v/w2v100-300.txt', 'concept': '/nlp/data/romap/conceptnet/numberbatch-en-17.06.txt'}
    w2v_file = wvec_paths[w2v_name]
